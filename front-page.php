        ...
        <div class="col-lg-7 px-0">
            <div class="owl-carousel main-carousel position-relative">
                ...
                <div
                    ...
                    <img
                        class="img-fluid h-100"
                        src="<?php bloginfo('template_url') ?>/img/news-800x500-3.jpg"
                        style="object-fit: cover" />
                    <div class="overlay">
                        <div class="mb-2">
                            <a
            ...
            <div class="row mx-0">
                ...
                <div class="col-md-6 px-0">
                    <div
                        ...
                        <img
                            class="img-fluid w-100 h-100"
                            src="<?php bloginfo('template_url') ?>/img/news-700x435-2.jpg"
                            style="object-fit: cover" />
                        <div class="overlay">
                            <div class="mb-2">
                                <a
                ...
                <div class="col-md-6 px-0">
                    <div
                        ...
                        <img
                            class="img-fluid w-100 h-100"
                            src="<?php bloginfo('template_url') ?>/img/news-700x435-3.jpg"
                            style="object-fit: cover" />
                        <div class="overlay">
                            <div class="mb-2">
                                <a
                ...
                <div class="col-md-6 px-0">
                    <div
                        ...
                        <img
                            class="img-fluid w-100 h-100"
                            src="<?php bloginfo('template_url') ?>/img/news-700x435-4.jpg"
                            style="object-fit: cover" />
                        <div class="overlay">
                            <div class="mb-2">
                                <a
                    ...
                    <div
                        ...
                        <div class="text-truncate">
                            <a
                                ...
                                href="">Lorem ipsum dolor sit amet elit. Proin interdum lacus eget
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="bg-white text-center border border-top-0 p-3">
                        <a href=""><img class="img-fluid" src="<?php bloginfo('template_url') ?>/img/news-800x500-2.jpg" alt="" /></a>
                    </div>
                </div>
                <!-- Ads End -->
                ...
                <div class="mb-3">
                    ...
                    <div class="bg-white border border-top-0 p-3">
                        ...
                        <div
                            class="d-flex align-items-center bg-white mb-3"
                            style="height: 110px">
                            <img class="img-fluid" src="<?php bloginfo('template_url') ?>/img/news-110x110-5.jpg" alt="" />
                            <div
                                class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a
