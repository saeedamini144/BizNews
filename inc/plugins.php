...
function BizNews_required_plugins()
{
    /*
	 ...
	 */
    $config = array(
        'id'           => 'BizNews',                 // Unique ID for hashing notices for multiple instances of TGMPA.
...
add_action('tgmpa_register', 'BizNews_required_plugins');
